...
<head>
  ...
  <style>
    ...
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .org { font-size:11px;letter-spacing:0.08em; text-transform:uppercase; margin-bottom:4px; }
    ...
    .filter-label { margin-bottom:4px; font-size:10px; text-transform:uppercase; letter-spacing:0.06em; }
